...
<head>
    ...
    <link rel="stylesheet" href="<?=getUrl('css/style.css');?>">
</head>
<body>
<div class="container row">
    <header class="header">
        ...
        <nav class="header__navigation">
            <ul>
                <li>
                    <a href="<?=getUrl();?>" class="header__link header__link_main"></a>
                </li>
                <li>
    ...
    <main class="main">
        <section class="wrapper">
            <div class="main-header">
                <a href="<?=getUrl();?>" class="header__link header__link_home" title="Лента"></a>
